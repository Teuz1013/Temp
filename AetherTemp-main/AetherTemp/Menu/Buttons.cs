    ...
    internal class Buttons
    {
        public static ButtonInfo[][] buttons = new ButtonInfo[][]
        {
            new ButtonInfo[] { // Main Mods
                ...
                new ButtonInfo { buttonText = "Virsuals", method =() => SettingsMods.visuals(), isTogglable = false, toolTip = "Opens the Visuals settings for the menu."},
            },
            ...
            new ButtonInfo[] { // Movement
                new ButtonInfo { buttonText = "SpeedBoost", method =() => SpeedBoost.SpeedboostMod(), isTogglable = false, toolTip = "Makes you fast."},
            },
